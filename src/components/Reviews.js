...
<path d="M6.5 1L1.5 6L6.5 11" stroke="#72727E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
</a>
                    <a className="active"><svg width="8" height="12" viewBox="0 0 8 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1.5 11L6.5 6L1.5 1" stroke="#EEEEEE" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
</a>
                </div>
            </div>
